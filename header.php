...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        <p class="font-rale font-size-12 text-black-50 m-0">Andhra University - online mobile store</p>
        <div class="font-rale font-size-14">
            <a href="login.html" class="px-3 border-right border-left text-dark">Login</a>
            <a href="wishlist.html" class="px-3 border-right text-dark">Wishlist (3)</a>
        </div>
    </div>
